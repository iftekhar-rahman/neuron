<?php get_header(); ?>
	...
	<?php 
		...
		if ( array_key_exists( 'big_review', $work_meta ) ) {
			$big_review = $work_meta['big_review'];
		} else {
			$big_review = '';
		}
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="single-portfolio-images">
						<?php 
							$big_portfolio_img = wp_get_attachment_image_src($big_review, 'large');
						?>
						<?php if(!empty($big_review)) : ?>
