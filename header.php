	        ...
	        <nav class="navbar navbar-default navbar-sticky bootsnav">
	            ...
	            <div class="container">
	                ...
	                <div class="collapse navbar-collapse" id="navbar-menu">
						<?php
						$neuron_menu = wp_nav_menu( array(
							'theme_location' => 'menu-1',
							'menu_id'        => 'menu-1',
							'menu_class'     => 'nav navbar-nav navbar-right',
							'echo'           => false
						) );
						// $neuron_menu = str_replace("menu-item-has-children","menu-item-has-children has-children",$neuron_menu);
    					echo wp_kses_post($neuron_menu);
						?>
	                </div><!-- /.navbar-collapse -->
	            </div>
	        </nav>
